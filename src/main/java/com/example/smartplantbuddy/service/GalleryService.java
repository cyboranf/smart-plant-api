...
public class GalleryService {
    ...
    public GalleryService(GalleryRepository galleryRepository, GalleryMapper galleryMapper, PlantService plantService, GalleryValidator galleryValidator, AmazonS3 s3client) {
    ...
    public GalleryResponseDTO addImageToPlant(GalleryRequestDTO galleryRequestDTO) throws IOException {
        galleryValidator.plantForGalleryValidation(galleryRequestDTO);
    ...
    public void deleteImage(Long galleryId) {
        Gallery gallery = galleryValidator.deleteImageOfPlantValidation(galleryId);
    ...
    public List<GalleryResponseDTO> getGalleriesByPlantId(Long plantId) {
        galleryValidator.plantForGalleryValidationByID(plantId);
